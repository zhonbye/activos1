            ...
            @forelse ($activos as $activo)
                <tr data-id="{{ $activo->id_activo }}">
                    ...
                    <td class="text-center">
                        <button class="btn btn-sm btn-outline-warning editar-btn" data-id="{{ $activo->id_activo }}"
                            title="Editar">
...
@if ($activos->hasPages())
    <nav class="mt-2 bg-dark bg-opacity-10 rounded">
        <ul class="pagination pagination-sm justify-content-center mb-0">
            ...
            @else
                <li class="page-item"><a class="page-link" href="{{ $activos->previousPageUrl() }}"
                        rel="prev">&laquo;</a></li>
            @endif
            ...
            @if ($activos->hasMorePages())
                <li class="page-item"><a class="page-link" href="{{ $activos->nextPageUrl() }}"
                        rel="next">&raquo;</a></li>
            @else
