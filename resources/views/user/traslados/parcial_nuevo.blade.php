...
$(document).on('input', '#form_traslado input[name="gestion"]', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#modalNuevoTraslado #form_traslado #numero_documento').val(response.siguiente_numero);
                        $('#modalNuevoTraslado .btn-close').trigger('click');
                        $('.modal-backdrop').remove();
// $('#modalNuevoTraslado #form_traslado #numero_documento').text(response.siguiente_numero);
// alert($('#modalNuevoTraslado #form_traslado input[name="gestion"]').val())
                        ...
                        //     });
                        // }
                        //el codigo de arriba no quiere cerra rel modla se cuelga al guardar
                        

// alert($('#modalNuevoTraslado').html())
