...
{{-- <div class="empty_sp" style="height:160px;"></div> --}}
    ...
    {{-- <div class="main"> --}}
        ...
        <div class="alger">ACTA DE TRASLADO</div>
...
<div class="traslado-info" style="font-size:13px; font-family: Arial, sans-serif; margin-top:10px; background: transparent; display:flex; flex-direction:column; gap:8px;">

    <!-- Fila 1: En fecha -->
    <div style="display:flex; justify-content:flex-start; gap:10px;">
        <div style="flex:1; text-align:right; font-weight:bold;">En fecha:</div>
        <div style="flex:3; text-align:left;">{{ $fecha_traslado_literal }}</div>
    </div>
    ...
    <div style="display:flex; justify-content:flex-start; gap:10px;">
        ...
        <p>
            ...
            {{ $responsables['director'] ?? '-' }} y {{ $responsables['administrador'] ?? '-' }} se procede a la traslado
